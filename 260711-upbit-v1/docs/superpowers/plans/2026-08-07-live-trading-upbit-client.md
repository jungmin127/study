...
**Architecture:** `docs/superpowers/specs/2026-08-04-live-trading-foundation-design.md`의 1단계
로드맵 중 서브플랜③(`docs/superpowers/plans/2026-08-07-live-trading-indicators-b-group.md`, main에
커밋됨) 다음 순서인 서브플랜④다.
