...
**Goal:** `docs/superpowers/specs/2026-08-31-regime-ml-stock-index-features-design.md`에서 승인된 설계대로 S&P500/다우존스/나스닥 3개 지수의 일간 수익률(`SP500_RETURN`/`DJIA_RETURN`/`NASDAQ_RETURN`)을 장세 판별 ML 피처로 추가하고, 실데이터 walk-forward 재학습으로 채택/폐기를 결정한다.
