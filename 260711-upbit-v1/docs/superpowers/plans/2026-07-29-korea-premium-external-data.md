...
**Goal:** `docs/superpowers/specs/2026-07-29-korea-premium-external-data-design.md`에서 설계한 대로,
...
`docs/superpowers/specs/2026-07-29-korea-premium-external-data-design.md`의 "이 스펙에 포함하지 않은 것"
절과 동일한 이유로 범위 밖이다.
