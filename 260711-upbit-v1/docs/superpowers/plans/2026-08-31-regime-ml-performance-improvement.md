...
**Goal:** `docs/superpowers/specs/2026-08-31-regime-ml-performance-improvement-design.md`의 4개 항목(threshold 튜닝+확률보정, sample uniqueness 가중치+vol_t shift, 베타중립 cross-sectional 피처, 캔들 결측구간 스캔+보정)을 순서대로 구현해 장세 판별 ML의 walk-forward pooled weighted kappa(현재 baseline 0.097)를 개선한다.
...
```markdown
**② 모델 성능 개선 완료(2026-08-31)**: `docs/superpowers/specs/2026-08-31-regime-ml-performance-improvement-design.md`
