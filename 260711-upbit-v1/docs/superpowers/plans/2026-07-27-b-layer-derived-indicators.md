...
**Goal:** `docs/superpowers/specs/2026-07-27-strategy-source-classification.md`에서 B 레이어로 분류된
...
`docs/superpowers/specs/2026-07-27-strategy-source-classification.md`의 B 레이어 중 다음 2개는
