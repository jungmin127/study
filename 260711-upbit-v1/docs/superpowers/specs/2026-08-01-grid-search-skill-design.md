...
1. `python scripts/grid_search.py --market KRW-ETH --timeframe minutes60 --capital 10000000 --start 2026-06-01 --end 2026-07-31 --top-n 20` 직접 실행 → 2026-08-01 세션 프로토타입 결과(1위 STOCH_D<10/RSI>80, +15.46%)와 동일한지 대조.
2. SKILL.md를 통해 자연어 명령(`grid search 이더리움,1000만원,1시간,2026-06-01~2026-07-31,20`)으로 동일 결과 재현.
