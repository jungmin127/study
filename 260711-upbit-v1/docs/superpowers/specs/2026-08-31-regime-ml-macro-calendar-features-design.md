...
- ECB 기준 공식 환율, 영업일 기준 일 1회 갱신(주말·공휴일 결측 — `merge_asof(backward)`로
  자연 처리).
- 과거 스펙(`docs/superpowers/specs/2026-07-29-korea-premium-external-data-design.md`)에서
...
- `docs/superpowers/specs/2026-08-31-regime-ml-performance-improvement-design.md`와
