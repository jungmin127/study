...
다른 실험(설계: `docs/superpowers/specs/2026-08-30-regime-ml-hmm-feature-design.md`)의
...
백테스트 분석(설계: `docs/superpowers/specs/2026-08-30-regime-fact-label-backtest-analysis-design.md`,
