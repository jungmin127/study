...
**Goal:** `docs/superpowers/specs_v1/2026-07-31-vpvr-volume-profile-design.md`에서 설계한 대로, 가격대별
...
`docs/superpowers/specs_v1/2026-07-31-vpvr-volume-profile-design.md`의 "이 스펙에 포함하지 않은 것" 절과
동일한 이유로 범위 밖이다.
