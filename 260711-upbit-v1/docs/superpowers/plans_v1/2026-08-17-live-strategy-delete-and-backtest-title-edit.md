...
- 백테스트 제목/설명 수정 시 `backtest_runs.created_at`도 함께 `datetime('now')`로 갱신한다 (스펙 결정 — `docs/superpowers/specs_v1/2026-08-17-live-strategy-delete-and-backtest-title-edit-design.md` 참고).
