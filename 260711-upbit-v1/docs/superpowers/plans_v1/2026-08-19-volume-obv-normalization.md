...
- `VOLUME_PCT`/`OBV_ROC` 공식은 `docs/superpowers/specs_v1/2026-08-19-volume-obv-normalization-design.md`에서 확정한 그대로다: `VOLUME_PCT = (거래량 - VOLUME_SMA) / VOLUME_SMA × 100`, `OBV_ROC = (OBV[0] - OBV[N봉전]) / (최근 N봉 거래량 합) × 100`.
