...
- 스펙 문서: `docs/superpowers/specs_v1/2026-08-24-regime-detector-reversal-gating-design.md`
- `engine/regime_features.py`는 `engine/regime_detector.py`와 마찬가지로 순수 함수만 담는다
  ...
  재사용 가능해야 한다는 기존 설계 철학(`docs/superpowers/specs_v1/2026-08-23-realtime-regime-detector-design.md:41-44`)을 따른다.
...
docs/superpowers/specs_v1/2026-08-24-regime-detector-reversal-gating-design.md
...
**Files:**
- Modify: `docs/superpowers/specs_v1/2026-08-24-regime-detector-reversal-gating-design.md` (검증 결과 절 추가)
...
`docs/superpowers/specs_v1/2026-08-24-regime-detector-reversal-gating-design.md` 끝에 `## 검증 결과(YYYY-MM-DD)` 절을 추가해 Step 2에서 확인한 수치(마켓별 상관계수 전/후, 정반대 오분류 건수 전/후)를 기록한다.
...
git add docs/superpowers/specs_v1/2026-08-24-regime-detector-reversal-gating-design.md
