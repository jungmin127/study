...
# 이유로 모듈 간 동기화가 필요한 상수) — VOLATILITY_PERCENTILE/LIQUIDITY_PERCENTILE는
# 이 윈도우로 계산되는 롤링 백분위라, 여기서 더 짧은 기간만 불러오면 학습 때와 다른
# 통계(1년 백분위가 아니라 몇십 일 백분위)가 되어 train/serve skew가 생긴다.
WARMUP_DAYS = 370
