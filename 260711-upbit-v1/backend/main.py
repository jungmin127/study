...
INDICATOR_CATALOG: list[dict] = [
    ...
    {
        "value": "KOREA_PREMIUM", "label": "한국프리미엄 (KRW 대비 USDT)", "category": "시장 심리",
        "params": [],
        "description": "Upbit 종가와 Binance 종가(USDT)의 차이를 나타내는 지표로, 한국의 원화 유동성과 시장심리를 반영합니다. 양수이면 한국 프리미엄이 있다는 의미로, 한국 투자자들의 강한 수요나 FOMO를 시사합니다.",
        "example": "연산자 >, 임계값 0이면: 한국프리미엄이 양수인 구간(한국 시장이 국제 시장 대비 고평가)을 포착해 국내 수급 강도를 필터링할 수 있습니다.",
    },
    {
